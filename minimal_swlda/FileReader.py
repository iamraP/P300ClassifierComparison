...
def ParseParam(param):
	...
	if datatype in ('int', 'float'):
		...
		val = param[0]
		if name == "PreSequenceDuration": #TODO proper calculation of PreSequence Duration chaning this into a proper value didn't change anything
		 	val= "0.5s"
		if name == "VisualizeSourceBufferSize": #changing this doesn't change anything
			val= "1s"
